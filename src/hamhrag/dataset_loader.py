"""
Benchmark dataset loader for HamhRag.
...
HamhRag decomposes before retrieving:  sub-q1 → "Who directed Gravity?" →
...
SUPPORTED_DATASETS: dict[str, dict] = {
    ...
    "squad_v2": {
        ...
        "type": "single_hop",
        "difficulty": "easy",
        "difficulty_note": "Answer is directly in the passage. Normal RAG \u2248 HamhRag here.",
