"""
hamhrag.eval — Local benchmark runner for HamhRag.

Usage
-----
Run against a JSONL file of {question, answer} pairs:

    python -m hamhrag.eval --dataset data/benchmark/sample.jsonl
...
Each output record will have:
  ...
  - "predicted" (str): HamhRag's final answer
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="HamhRag local benchmark runner")
