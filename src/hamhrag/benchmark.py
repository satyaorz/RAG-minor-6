"""
hamhrag.benchmark — Latency/throughput benchmark for HAMH-RAG vs Normal RAG.

Usage
-----
python -m hamhrag.benchmark --dataset data/benchmark/sample.jsonl --limit 50
"""
...
def _run_normal_rag(pipeline: HamhRagPipeline, question: str) -> None:
