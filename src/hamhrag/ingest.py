...
from hamhrag.retrieval.scoring import normalize_text
...
def build_local_indices(settings: HamhRagSettings | None = None) -> IngestReport:
...
def _build_faiss_index(
    ...
    from hamhrag.backends.vector import _load_sentence_transformer
    from hamhrag.retrieval.scoring import normalize_text
